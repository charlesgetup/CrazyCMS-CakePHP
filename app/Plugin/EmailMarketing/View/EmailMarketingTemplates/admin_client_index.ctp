<div class="row">
    <div class="col-xs-12">
        <div class="row email-templates">
            <h4><?php echo __('Own Templates'); ?></h4>
            <?php
                ...
                $actions = array(
                    '<i class="ace-icon fa fa-edit bigger-110"></i><span>' .__('Edit') .'</span>' => array('/admin/email_marketing/email_marketing_templates/edit/', 'EmailMarketingTemplate.id', '', array('class' => 'btn btn-block', 'escape' => false, 'target' => '_blank')),
                    '<i class="ace-icon fa fa-trash-o bigger-110"></i><span>' .__('Delete') .'</span>' => array('/admin/email_marketing/email_marketing_templates/delete/', 'EmailMarketingTemplate.id', '', array('class' => 'btn btn-block', 'escape' => false, 'target' => '_blank'))
                );
                ...
                echo $this->PricingTable->createTable(
                    ...
                    $displayFields,
                    $actions,
                    __('You did\'t create any template for now.'),
                    $substitutions
                );
            ?>
        </div>
    ...
    <span class="space-32">&nbsp;</span>
    <a class="btn btn-success create-template-btn" href="/admin/email_marketing/email_marketing_templates/add" target="_blank"><?php echo __('Create template'); ?></a>
</div><!-- /.row -->
