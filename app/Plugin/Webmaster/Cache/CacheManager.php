 ...
 */
	public static function usage() {
		...
		return array(
			'files' => array(
				'used' => Server::convert(Server::fileSize(glob(CACHE . '{.,*}' . DS . '*', GLOB_BRACE)), 'mb'),
				'total' => Server::convert($total, 'mb'),
				'available' => Server::convert($avail, 'mb')
			),
			'assets' => array(
				'used' => Server::convert(Server::fileSize(glob(APP . 'webroot' . DS . '*' . DS . '*')), 'mb'),
				'total' => Server::convert($total, 'mb'),
				'available' => Server::convert($avail, 'mb')
			)
		);
