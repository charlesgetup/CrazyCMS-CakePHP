            ...
            <div class="col-sm-offset-1 col-sm-10">
                <div class="tabbable">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane in active" id="edit-live-chat-plan">
                            <?php
                        ...
                        <div class="tab-pane" id="edit-live-chat-plan-users">
                            <iframe src="/admin/live_chat/live_chat_users/index/<?php echo $plan['LiveChatPlan']['id']; ?>/<?php echo $this->request->params['action']; ?>?iframe=1" frameborder="0" scrolling="no" seamless="seamless" width="100%" onload="initIframe(this);"></iframe>
                        </div>
                        <div class="tab-pane" id="add-live-chat-plan-user">
                            <iframe src="/admin/live_chat/live_chat_users/add/<?php echo $plan['LiveChatPlan']['id']; ?>?iframe=1" frameborder="0" scrolling="no" seamless="seamless" width="100%" onload="initIframe(this);"></iframe>
                        </div>
                    </div>
                </div>
            </div>
