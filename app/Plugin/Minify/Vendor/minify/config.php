 ...
 */
$min_builderPassword = 'MIIBIjANBgkqhkiG9w0BAQEFAAOCAQ8AMIIBCgKCAQEAvGrjudVDkzhjpLRj12';
...
/**
 * To debug minify function, set it to true
 */
 ...
 */
$min_serveOptions['maxAge'] = 864000000;
...
/**
 * To use the JS compressor that shipped with 2.x, uncomment the following line:
 */
$min_serveOptions['minifiers'][Minify::TYPE_JS] = array('JSMin\\JSMin', 'minify'); // Because the default options are not merged recursively, we have to obviously set the minifier

/**
 * To use the HTML compressor that shipped with 2.x, uncomment the following line:
 */
$min_serveOptions['minifiers'][Minify::TYPE_HTML] = array('Minify_HTML', 'minify'); // Because the default options are not merged recursively, we have to obviously set the minifier
...
/**
 * Add post processer. For css, it is used to remove \r\n and comments, for JS, it is tried to encrypt the content
 */
$min_serveOptions['postprocessor'] = 'Minify_postHandler';
$min_serveOptions['postprocessorRequire'] = __DIR__ .'/utils.php';

/**
 * Encrypt file and prevent being copied by others
 */
$min_serveOptions['encryptFilesIdentifier'] = array('.encrypted.js'); // List common file names which need to be encrypted
$min_serveOptions['encryptProcessor'] = 'Minify_encryptor';
$min_serveOptions['encryptProcessorRequire'] = __DIR__ .'/utils.php';
