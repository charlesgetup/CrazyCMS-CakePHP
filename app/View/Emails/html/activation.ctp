                        ...
                        <tr>
                            <td class="table-col-td" width="378"
                                ...
                                <div
                                    ...
                                    <?php echo __("We provide reliable and flexible online services."); ?>
                                </div>
                        ...
                        <tr>
                            <td class="table-col-td" width="378"
                                ...
                                <div
                                    ...
                                    <a
                                        href="http://<?php echo $companyDomain; ?>/account/activate/<?php echo $token; ?>"
                                        ...
                                        title="Reset Password" target="_blank"> &nbsp;<?php echo __("Activate Account"); ?>
                                        &nbsp;
                                    </a>
                                </div>
                                <table class="table-space" height="16"
