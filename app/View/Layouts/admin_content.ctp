<!--
    This is used as main layout by the pages in admin user backend after logged in
-->
...
<head>
	...
	<?php echo $this->Minify->script(array('admin/pace'), array('data-pace-options' => '{ "ajax": true, "document": true, "eventLag": false, "elements": false }')); ?>
...
<body class="no-skin">
    <?php echo $this->element('page/admin/nav_bar'); ?>
    ...
    <div class="main-container" id="main-container">
        ...
        <?php echo $this->element('page/admin/side_bar'); ?>
        
        <div class="main-content">
            
            <?php echo $this->element('page/admin/content_nav_bar'); ?>
    ...
    <script type="text/javascript">
        window.jQuery && document.write('<?php echo str_replace("</script>", "<'+'/script>", $this->Minify->script(array('admin/iframeResizer/iframeResizer.min'))); ?>');
    </script>
    <?php 
        // Because our parser cannot handle a file which is more than 10KB, I have to split large JS files into smaller ones.
        $encryptedJS = $this->Minify->script(array(
    ...
    <?php
        ...
        /* 
         * The following PHP code can only run once when the page is loaded. But sometimes in this page, client needs to send multiple AJAX requests.
