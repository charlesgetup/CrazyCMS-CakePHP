...
<title><?php echo isset($emailTitle) ? $emailTitle : ""; ?></title>
<style type="text/css">
body {
    width: 100%;
    margin: 0;
                ...
                <table>
                    <tr>
                        <td class="table-td-wrap" align="center" width="608"><div
                                ...
                                <?php echo __("Can't read this email?"); ?> <a href="http://help.campaignmonitor.com/topic.aspx?t=96" target="_blank"
                                    style="color: #478fca; text-decoration: none; font-size: 14px; background-color: transparent;">
                                    <?php echo __("View the plain text version"); ?> &rarr; </a>
                            </div>

                            <table class="table-row"
                                style="table-layout: auto; padding-right: 24px; padding-left: 24px; width: 600px; background-color: #ffffff;"
                                bgcolor="#FFFFFF" width="600" cellspacing="0" cellpadding="0"
                                border="0">
                                <tbody>
                                    <tr height="55px"
                                        ...
                                        <td class="table-row-td"
                                            ...
                                            valign="middle" align="left"><a href="#"
                                            style="color: #428bca; text-decoration: none; padding: 0px; font-size: 18px; line-height: 20px; height: 50px; background-color: transparent;">
                                                <?php echo isset($emailTitle) ? $emailTitle : ""; ?> </a></td>
                                        ...
                                        <td class="table-row-td"
                                            ...
                                            align="right" valign="middle"><a href="#" target="_blank"
                                            style="color: #428bca; text-decoration: none; font-size: 15px; background-color: transparent;">
                                                <?php echo __("Contact Us"); ?></a></td>
                                    </tr>
                                </tbody>
                            </table>
                            ...
                            <table class="table-space" height="6"
                                ...
                                width="600" bgcolor="#E4E6E9" cellspacing="0" cellpadding="0"
                                border="0">
                                <tbody>
                                    <tr>
                                        <td class="table-space-td" valign="middle" height="6"
                                            style="height: 6px; width: 600px; background-color: #e4e6e9;"
                                            width="600" bgcolor="#E4E6E9" align="left">&nbsp;</td>
                                    </tr>
                                </tbody>
                            </table>
                            <table class="table-space" height="16"
                                style="height: 16px; font-size: 0px; line-height: 0; width: 600px; background-color: #ffffff;"
                                width="600" bgcolor="#FFFFFF" cellspacing="0" cellpadding="0"
                                border="0">
                                <tbody>
                                    <tr>
                                        <td class="table-space-td" valign="middle" height="16"
                                            style="height: 16px; width: 600px; background-color: #ffffff;"
                            ...
                            <table class="table-space" height="24"
                                style="height: 24px; font-size: 0px; line-height: 0; width: 600px; background-color: #ffffff;"
                                width="600" bgcolor="#FFFFFF" cellspacing="0" cellpadding="0"
                                border="0">
                                <tbody>
                                    <tr>
                                        <td class="table-space-td" valign="middle" height="24"
                                            style="height: 24px; width: 600px; padding-left: 18px; padding-right: 18px; background-color: #ffffff;"
                                    ...
                                    <tr>
                                        <td class="table-row-td"
                                            ...
                                            <table class="table-col" align="left" width="273"
                                                style="padding-right: 18px; table-layout: fixed;"
                                                cellspacing="0" cellpadding="0" border="0">
                                                <tbody>
                                                    <tr>
                                                        <td class="table-col-td" width="255"
                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        <td class="header-row-td" width="255"
                                                                            ...
                                                                            valign="top" align="left"><?php echo __("Our Social Channels"); ?></td>
                                                                    </tr>
                                                                </tbody>
                                                            </table>
                                                            ...
                                                            <div
                                                                ...
                                                                <a href="#"
                                                                    style="color: #ffffff; text-decoration: none; margin: 0px; text-align: center; vertical-align: baseline; border: 4px solid #6fb3e0; padding: 4px 9px; font-size: 14px; line-height: 19px; background-color: #6fb3e0;">Twitter</a>
                                                                <a href="#"
                                                                    style="color: #6688a6; text-decoration: none; margin: 0px; text-align: center; vertical-align: baseline; border-width: 1px 1px 2px; border-style: solid; border-color: #8aafce; padding: 6px 12px; font-size: 14px; line-height: 20px; background-color: #ffffff;">Facebook</a>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            ...
                                            <table class="table-col" align="left" width="255"
                                                cellspacing="0" cellpadding="0" border="0"
                                                            ...
                                                            <table class="header-row" width="255" cellspacing="0"
                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        <td class="header-row-td" width="255"
                                                                            style="font-family: Arial, sans-serif; font-weight: normal; line-height: 19px; color: #478fca; margin: 0px; font-size: 18px; padding-bottom: 8px; padding-top: 10px;"
                                                                            valign="top" align="left"><?php echo __("Our Contact Info"); ?></td>
                                                                    </tr>
                                                                </tbody>
                                                            </table> <?php echo __("Phone"); ?>: 9743 6072 <br> <?php echo __("Email"); ?>: <a href="mailto:<?php echo $companyEmail; ?>" style="color: #428bca; text-decoration: none; background-color: transparent;"><?php echo $companyEmail; ?></a>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                ...
                                <tbody>
                                    <tr>
                                        <td class="table-row-td"
                                            style="font-family: Arial, sans-serif; line-height: 19px; color: #444444; font-size: 13px; font-weight: normal; padding-left: 36px; padding-right: 36px;"
                                            valign="top" align="left">
                                            <table class="table-col" align="left" width="528"
                                                cellspacing="0" cellpadding="0" border="0"
                                                style="table-layout: fixed;">
                                                <tbody>
                                                    <tr>
                                                        <td class="table-col-td" width="528"
                                                            ...
                                                            <table class="table-space" height="16"
                                                                ...
                                                                width="528" bgcolor="#FFFFFF" cellspacing="0"
                                                                cellpadding="0" border="0">
                                                                <tbody>
                                                                    <tr>
                                                                        <td class="table-space-td" valign="middle" height="16"
                                                            ...
                                                            <div
                                                                ...
                                                                <?php echo date("Y"); ?> <?php echo __("by ") .$companyName; ?></div>
                                                            <table class="table-space" height="12"
                                                            ...
                                                            <div
                                                                ...
                                                                <a href="#"
                                                                    style="color: #428bca; text-decoration: none; background-color: transparent;"><?php echo __("Terms"); ?></a>
                                                                &nbsp;|&nbsp; <a href="#"
                                                                    style="color: #428bca; text-decoration: none; background-color: transparent;"><?php echo __("Privacy"); ?></a>
                                                            </div>
                                                            <table class="table-space" height="16"
                                                                style="height: 16px; font-size: 0px; line-height: 0; width: 528px; background-color: #ffffff;"
                                                                width="528" bgcolor="#FFFFFF" cellspacing="0"
                                ...
                                <tbody>
                                    <tr>
                                        <td class="table-space-td" valign="middle" height="8"
                                            style="height: 8px; width: 600px; background-color: #e4e6e9;"
                                            width="600" bgcolor="#E4E6E9" align="left">&nbsp;</td>
                                    </tr>
                                </tbody>
                            </table></td>
