	...
	<table width="100%" height="100%" bgcolor="#E4E6E9" cellspacing="0"
		...
		<tr>
			<td width="100%" align="center" valign="top" bgcolor="#E4E6E9"
				...
				<table>
					<tr>
						<td class="table-td-wrap" align="center" width="458"><table
								class="table-space" height="18"
																...
																<tbody>
																	<tr>
																		<td class="header-row-td" width="378"
																			...
																			valign="top" align="left"><?php echo isset($emailTitle) ? $emailTitle : ""; ?></td>
																	</tr>
																</tbody>
															</table>
														</td>
																...
																<tbody>
																	<tr>
																		<td width="100%" align="center" bgcolor="#f5f5f5"
																			...
																			valign="top"><a href="#"
																			style="color: #428bca; text-decoration: none; background-color: transparent;"><?php echo $companyName; ?>
																				&copy; <?php echo date("Y"); ?></a> <br> <a href="#"
