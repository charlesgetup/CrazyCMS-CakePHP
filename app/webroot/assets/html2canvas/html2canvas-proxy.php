...
//setup
define('PATH', dirname(__FILE__) .'/tmp-remote-img'); //relative folder where the images are saved
define('PATH_PERMISSION', 0755);  //use 644 or 666 for remove execution for prevent sploits
