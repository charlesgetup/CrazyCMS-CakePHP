...
var _exportData = function ( dt, inOpts )
{
	...
	/* Hack this export data function to allow passing function to "exportOptions.columns" */
	if(Object.prototype.toString.call( config.columns ) === '[object Function]'){
	...
	/* Hack this export data function to allow export all rows when no row is selected. */
	if(config.modifier.selected && dt.table().rows('.selected').data().length == 0){
		config.modifier.selected = false;
	}
	/* Hack ends */
