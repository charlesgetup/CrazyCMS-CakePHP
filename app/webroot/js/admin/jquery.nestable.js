    ...
    Plugin.prototype = {
        ...
        init: function()
        {
            ...
            var onStartEvent = function(e)
            {
                ...
                if(typeof list.options.onStart === "function"){
                	list.options.onStart(list, e);
                }
            };
            ...
            var onMoveEvent = function(e)
            {
                if (list.dragEl) {
                    ...
                    if(typeof list.options.onMove === "function"){
                    	list.options.onMove(list, e);
                    }
                }
            };
            ...
            var onEndEvent = function(e)
            {
				if (list.dragEl) {
                    ...
                    if(typeof list.options.onEnd === "function"){
                    	list.options.onEnd(list, e);
                    }
                }
            };
