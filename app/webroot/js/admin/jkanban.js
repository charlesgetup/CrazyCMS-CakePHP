...
(function () {
    ...
    this.jKanban = function () {
        ...
        this.init = function () {
            ...
            if (window.innerWidth > self.options.responsive) {
                ...
                self.drake = self.dragula(self.boardContainer, {
                    ...
                    accepts: function (el, target, source, sibling) {
                    	return target.classList.contains('kanban-drag');
                    },
                    revertOnSpill: true
                })
        ...
        this.addElement = function (boardID, element) {
            ...
            nodeItem.innerHTML = '<div class="item-status"><span class="label">' + element.status + '</span></div><div class="item-title">' + element.title + '</div>';
            if(element.editLinkSelector){
            	nodeItem.innerHTML = '<div class="item-actions"><button data-toggle="dropdown" class="dropdown-toggle" aria-expanded="true"><i class="ace-icon fa fa-angle-down"></i></button><ul class="dropdown-menu"><li><a class="' + element.editLinkSelector + '">' + element.editTxt + '</a></li><li><a class="' + element.deleteLinkSelector + '">' + element.deleteTxt + '</a></li></ul></div>' + nodeItem.innerHTML;
            }
        ...
        this.addBoards = function (boards) {
            ...
            for (var boardkey in boards) {
                ...
                if(!self.options.dragItems){
                	contentBoard.classList.add('no-drag');
                }
                //add drag to array for dragula
                self.boardContainer.push(contentBoard);
                for (var itemkey in board.item) {
                	if(itemkey == 'last'){ continue; } // Remove the last undefined board item
                    //create item
                    ...
                    if(itemKanban.id){
                        ...
                        nodeItem.innerHTML = '<div class="item-status"><span class="label">' + itemKanban.status + '</span></div><div class="item-title">' + itemKanban.title + '</div>';
                        if(itemKanban.editLinkSelector){
                        	nodeItem.innerHTML = '<div class="item-actions"><button data-toggle="dropdown" class="dropdown-toggle" aria-expanded="true"><i class="ace-icon fa fa-angle-down"></i></button><ul class="dropdown-menu"><li><a class="' + itemKanban.editLinkSelector + '">' + itemKanban.editTxt + '</a></li><li><a class="' + itemKanban.deleteLinkSelector + '">' + itemKanban.deleteTxt + '</a></li></ul></div>' + nodeItem.innerHTML;
                        }
        ...
        function __onclickHandler(nodeItem, clickfn) {
            nodeItem.addEventListener('click', function (e) {
            	// Click Func only works on the Kanban item. If user click other element, we still trigger the normal click event
            	if(e.target.tagName == "DIV" && (e.target.classList.contains("kanban-item") || e.target.classList.contains("item-title"))){
            		e.preventDefault;
