 ...
 */
	public function secure($fields = array()) {
		...
		if(Configure::read('debugSecurity')){
			error_log("Fields from FormHelper: ");
			error_log(print_r($fields, true));
			error_log("Locked from FormHelper: ");
			error_log(print_r($locked, true));
			error_log("Unlocked from FormHelper: ");
			error_log(print_r($unlockedFields, true));
		}

		$fields = Security::hash(serialize($fields) . $unlocked . Configure::read('Security.salt'), 'sha1');

		if(Configure::read('debugSecurity')){
			error_log('Token in FormHelper: ');
			error_log($fields);
		}
